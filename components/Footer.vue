<template>
  <div class="color">
    <v-container>
      <v-layout wrap row>
        <v-flex xs12 sm6 lg3>
          <div v-for="(item, i) in menu1" :key="'q' + i" class="background_none white--text footer-center">
            <div class="title mx-3 mt-5">{{ lang === 'mn' ? item.title: item.titleEn }}</div>
            <br />
            <div class="pb-1" v-for="(index, i) in item.asas" :key="'a' + i">
              <router-link
                class="footermenu"
                :to="{name:index.linkName, params:{id: index.mainCatId, subCat: index.submenuId,}}"
              >{{ lang === 'mn' ? index.subtitle: index.subTitleEn }}</router-link>
              
              <br />
            </div>
          </div>
          <div v-for="(item, i) in menu" :key="'w' + i" class="background_none white--text pr-4 footer-center">
            <div class="title mx-3 mt-5">{{ lang === 'mn' ? item.title: item.titleEn }}</div>
            <br />
            <div class="pb-1" v-for="(index, i) in item.asas" :key="'b' + i">
              <router-link
                class="footermenu"
                :to="{name:index.linkName, params:{id: index.mainCatId, subCat: index.submenuId,}}"
              >{{ lang === 'mn' ? index.subtitle: index.subTitleEn }}</router-link>
        ...
        <v-flex xs12 sm6 lg3>
          <div v-for="(item, i) in menu2" :key="'r' + i" class="background_none white--text footer-center">
            <div class="title mx-3 mt-5">{{ lang === 'mn' ? item.title: item.titleEn }}</div>
            <br />
            <div class="pb-1" v-for="(index, i) in item.asas" :key="'c' + i">
              <router-link
                class="footermenu"
                :to="{name:index.linkName, params:{id: index.mainCatId, subCat: index.submenuId,}}"
              >{{ lang === 'mn' ? index.subtitle: index.subTitleEn }}</router-link>
          ...
          <div v-for="(item, i) in menu3" :key="'t' + i" class="background_none white--text footer-center">
            <div class="title mx-3 mt-5">{{ lang === 'mn' ? item.title: item.titleEn }}</div>
            <br />
            <div class="pb-1" v-for="(index, i) in item.asas" :key="'d' + i">
              <router-link
                class="footermenu"
                :to="{name:index.linkName, params:{id: index.mainCatId, subCat: index.submenuId,}}"
              >{{ lang === 'mn' ? index.subtitle: index.subTitleEn }}</router-link>
        ...
        <v-flex xs12 sm6 lg3>
          <div v-for="(item, i) in menu4" :key="'y' + i" class="background_none white--text footer-center">
            <div class="title mx-3 mt-5">{{ lang === 'mn' ? item.title: item.titleEn }}</div>
            <br />
            <div class="pb-1" v-for="(index, i) in item.asas" :key="'e' + i">
              <router-link
                class="footermenu"
                :to="{name:index.linkName, params:{id: index.mainCatId, subCat: index.submenuId,}}"
              >{{ lang === 'mn' ? index.subtitle: index.subTitleEn }}</router-link>
          ...
          <div v-for="(item, i) in menu5" :key="'u' + i" class="background_none white--text footer-center">
            <div class="title mx-3 mt-5">{{ lang === 'mn' ? item.title: item.titleEn }}</div>
            <br />
            <div class="pb-1" v-for="(index, i) in item.asas" :key="'f' + i">
              <router-link
                class="footermenu"
                :to="{name:index.linkName, params:{id: index.mainCatId, subCat: index.submenuId,}}"
              >{{ lang === 'mn' ? index.subtitle: index.subTitleEn }}</router-link>
